#' @title area_model_parameters
#' @description parameters for lognormal distributions of ground floor areas, depending on region (qc2), house type (q1),
