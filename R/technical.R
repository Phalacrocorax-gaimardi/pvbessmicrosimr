...
scenario_params <- function(sD,yeartime){
  ...
  scen <- dplyr::bind_rows(scen,tibble::tibble(parameter="bess_cost", value=  bess_cost_fun(sD,yeartime)))
  scen <- dplyr::bind_rows(scen,tibble::tibble(parameter="bess_install_cost", value=  bess_install_cost_fun(sD,yeartime)))
